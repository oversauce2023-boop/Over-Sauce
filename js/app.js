...
function bindRestaurantInfo(){
  ...
  document.querySelectorAll("[data-bind='igLink']").forEach(el => el.setAttribute("href", M.restaurant.social.instagram));
  document.querySelectorAll("[data-bind='waLink']").forEach(el => el.setAttribute("href", M.restaurant.social.whatsappChannel));
...
window.OverSauceCore = {
  ...
  setupRevealObserver, applyLanguage, applyTheme
};
